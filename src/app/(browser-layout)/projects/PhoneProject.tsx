    ...
    return(
          <>
            ...
            <div className="max-h-120 flex w-full justify-center">
              <div className="carousel carousel-vertical rounded-box h-120 w-full p-5">
                  ...
                  <div key={idx} id={`${idx}`} className="carousel-item max-h-120 w-full flex flex-col overflow-auto">
                    <div className="card bg-base-100 image-full w-full shadow-sm h-120">
                      ...
                      <div className="card-body">
                        ...
                        <h2 className="text-lg text-success">{project.date}</h2>
                        ...
                        {project.languages && <div className="text-start text-accent">
                          Languages: {project.languages.map((lang, langIdx) => (
                            <div className={`badge ${language_to_color[lang.toLowerCase()] ? language_to_color[lang.toLowerCase()] : 'badge-primary'} mr-2`} key={projects.length + langIdx}>{lang}</div>
                          ))}
                        </div>}
